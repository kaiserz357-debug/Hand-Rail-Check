...
with st.sidebar:
    ...
    rail_sel = st.selectbox("Select Rail", list(materials.keys()), index=10)
    post_sel = st.selectbox("Select Post", list(materials.keys()), index=10)
...
if len(x_tops) >= 2:
    ...
    mid_y_rail = (y_tops[0] + y_tops[-1]) * 0.45
